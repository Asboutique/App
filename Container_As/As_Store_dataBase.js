    ...
    if(PI.length != 0 && PI[0].id != 0){
        ...
        if(sessionStorage.getItem("U_I") != 0){
            ...
            <div class="HPCD">
                ...
                <div class="HPCD_I" style="background-image: url('${PI[sessionStorage.getItem("U_I")].i}');"
                
                        data-i="${PI[sessionStorage.getItem("U_I")].i}"
                        data-n="${PI[sessionStorage.getItem("U_I")].n}"
                        data-p="${PI[sessionStorage.getItem("U_I")].p}"
                        data-id="${PI[sessionStorage.getItem("U_I")].id}"
                        data-lc="${PI[sessionStorage.getItem("U_I")].lc}"> 
                        
                        <img src="${PI[sessionStorage.getItem("U_I")].i}" class="Img_FC">
            ...
            //HPCD_I
            const HPCD_I=document.querySelectorAll('.HPCD_I');
            HPCD_I.forEach((e)=>{
                e.addEventListener('click',()=>{
                    ...
                    function HPCD_I(){
                        ...
                        let Quantity=0;
                        if(localStorage.getItem(`CI${dataDashed_Id}`) != null){
                            Quantity=Number(localStorage.getItem(`CI${dataDashed_Id}`).split('/')[1]);
                        }
                        ...
                        <div class="DIC_Q">
                            ...
                            data-id="${dataDashed_Id}"; data-price="${dataDashed_p}";>+</P>

                            <P class="DIC_QQ">${Quantity}</P>

                            <P class="DIC_QS" 
                            data-id="${dataDashed_Id}"; data-price="${dataDashed_p}";>-</P>

                        </div>
                        <P class="DIC_T"> &#8358 ${Quantity*Number(dataDashed_p)}</P>
                        <div class="HPCD_IS">
                            <p class="HPCD_IS_I"></p> In stock
                        </div>
                        `;
                        ...
                        document.querySelector('.DIC_QA').addEventListener('click',()=>{
                            let dataDashed_Id=document.querySelector('.DIC_QA').dataset.id;
                            let dataDashed_Price=document.querySelector('.DIC_QA').dataset.price;
                        ...
                        document.querySelector('.DIC_QS').addEventListener('click',()=>{
                            let dataDashed_Id=document.querySelector('.DIC_QS').dataset.id;
                            let dataDashed_Price=document.querySelector('.DIC_QS').dataset.price;
        ...
        if(localStorage.getItem("CCA_represh") === 'true'){
            ...
            <div class="CPCD_T">shopping cart</div> 
            <div class="Empty_C"></div>`;
        ...
        if(localStorage.getItem(`CI${PI[sessionStorage.getItem("CI")].id}`) != null && CCA.includes(PI[sessionStorage.getItem("CI")].id) != true){
            ...
            <div class="CPCD_B">
                <div class="CPCD_B_L">
                    <div class="CPCD_B_LI" style="background-image: url('${PI[sessionStorage.getItem("CI")].i}">
                        <img src="${PI[sessionStorage.getItem("CI")].i}" class="Img_FC">
                    </div>
                </div>
                <div class="CPCD_B_R">
                    ...
                    if(productId===Number(PI[i].id)){
                        ...
                        <div class="A_MCD_MAIN_SBD_B">
                            <div class="A_MCD_MAIN_SBD_B_L">
                                <div class="A_MCD_MAIN_SBD_B_LI" style="background-image: url('${PI[i].i}');">
